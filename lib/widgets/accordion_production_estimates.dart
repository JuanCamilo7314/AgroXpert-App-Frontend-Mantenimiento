...
Widget _contentAccordion(EstimatesProductionModel estimate) {
  return Column(
    children: [
      ...
      const SizedBox(height: 10),
      _fieldAgeFruits(estimate.ageFruits),
      const SizedBox(height: 10),
...
Widget _fieldAgeFruits(int ageFruits) {
  return Row(
    mainAxisAlignment: MainAxisAlignment.start,
    children: [
      const Icon(FlutterIcons.calendar_month_mco, color: Colors.green),
      const SizedBox(width: 8),
      const Text('Edad de frutas: ',
          style: TextStyle(fontWeight: FontWeight.bold)),
      Text('$ageFruits '),
    ],
  );
